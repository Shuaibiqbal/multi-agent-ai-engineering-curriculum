# Project 5 — ContentForge-Pro-Multi-Agent-Content-Platform-Production-Ready
...
```bash
cd project_5_production_capstone
python -m venv .venv
...
*Project: **ContentForge-Pro-Multi-Agent-Content-Platform-Production-Ready** — Step 1 of 4: ContentForge, Reachable Over HTTP for the First Time*
...
1. Write one FastAPI route, `POST /run-task`, that calls Project 4's graph directly and returns the result — kept only in memory, nothing saved yet.
...
**Stuck on this step?** [Hint 1](hints_and_solutions/step1_fastapi_route_hints.md#hint-1) · [Hint 2](hints_and_solutions/step1_fastapi_route_hints.md#hint-2) · [Hint 3](hints_and_solutions/step1_fastapi_route_hints.md#hint-3) · [Hint 4](hints_and_solutions/step1_fastapi_route_hints.md#hint-4) · [Show me the solution](hints_and_solutions/step1_fastapi_route_solution.md)
...
```
project_5_production_capstone/
├── api/
│   ├── main.py           → FastAPI app
│   ├── routes.py           → POST /run-task, GET /health
│   └── schemas.py            → request/response Pydantic models
└── (project_4_multi_agent_system's graph, imported, unchanged)
```

### Step 2 — Every Run Saved to a Database and Findable by ID

*Project: **ContentForge-Pro-Multi-Agent-Content-Platform-Production-Ready** — Step 2 of 4: Every Run Saved to a Database and Findable by ID*
...
1. Add a SQLite `Run` table (input, output, log, status, timestamps) and write to it on every request.
...
**Stuck on this step?** [Hint 1](hints_and_solutions/step2_database_persistence_hints.md#hint-1) · [Hint 2](hints_and_solutions/step2_database_persistence_hints.md#hint-2) · [Hint 3](hints_and_solutions/step2_database_persistence_hints.md#hint-3) · [Hint 4](hints_and_solutions/step2_database_persistence_hints.md#hint-4) · [Show me the solution](hints_and_solutions/step2_database_persistence_solution.md)
...
*Project: **ContentForge-Pro-Multi-Agent-Content-Platform-Production-Ready** — Step 3 of 4: Containerized and Rate-Limited: Runs the Same Everywhere, Survives Abuse*
...
2. Add basic in-memory rate limiting on `POST /run-task`.
...
**Stuck on this step?** [Hint 1](hints_and_solutions/step3_docker_rate_limiting_hints.md#hint-1) · [Hint 2](hints_and_solutions/step3_docker_rate_limiting_hints.md#hint-2) · [Hint 3](hints_and_solutions/step3_docker_rate_limiting_hints.md#hint-3) · [Hint 4](hints_and_solutions/step3_docker_rate_limiting_hints.md#hint-4) · [Show me the solution](hints_and_solutions/step3_docker_rate_limiting_solution.md)
...
*Project: **ContentForge-Pro-Multi-Agent-Content-Platform-Production-Ready** — Step 4 of 4: Test-Gated and Ready to Roll Back: No Regression Ships Quietly*
...
3. Build the Doc19 rollback function — goes back to the last version that actually passed, not just "whatever came before."
...
**Stuck on this step?** [Hint 1](hints_and_solutions/step4_test_gate_rollback_hints.md#hint-1) · [Hint 2](hints_and_solutions/step4_test_gate_rollback_hints.md#hint-2) · [Hint 3](hints_and_solutions/step4_test_gate_rollback_hints.md#hint-3) · [Hint 4](hints_and_solutions/step4_test_gate_rollback_hints.md#hint-4) · [Show me the solution](hints_and_solutions/step4_test_gate_rollback_solution.md)
...
**Final Deliverable:** **ContentForge-Pro-Multi-Agent-Content-Platform-Production-Ready** — ContentForge's 5 agents, served over FastAPI, saved to a database, containerized with secrets handled correctly, rate-limited, and protected by a test-gated release process with rollback.

# Project 9 (Bonus) — MCPCrew-Multi-Agent-Research-Team-Powered-By-MCP-Servers
...
> Not part of the numbered Doc01-19 project arc — a bonus/portfolio project that combines two earlier bonus projects' ideas: [Project 7](../project_7_mcp_server/)'s MCP server-building and [Project 8](../project_8_mcp_client_agent/)'s MCP client agent, applied inside [11_multi_agent_systems](../11_multi_agent_systems/)'s Supervisor pattern. Read Project 8's README and Doc11's Core Concepts first if you haven't already — this file has the full build spec, not a pointer elsewhere.
...
```bash
cd project_9_multi_agent_mcp_team
python -m venv .venv
...
```
project_9_multi_agent_mcp_team/
├── .env / .env.example

...
**Need something to search over?** If you don't have your own documents ready, load the Hugging Face dataset [`rag-datasets/rag-mini-wikipedia`](https://huggingface.co/datasets/rag-datasets/rag-mini-wikipedia) into your vector store — it's small, public domain, and made for exactly this kind of RAG practice. Your own text files work fine too; this is just a fast way to start testing.

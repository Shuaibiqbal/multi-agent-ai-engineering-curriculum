# Project 4 — ContentForge-Multi-Agent-Turn-Any-Topic-Into-A-Published-Brief

**Type:** Multi-agent (5 agents: 1 Supervisor + 4 specialists) · **Stack:** Python, LangGraph, `Command` tool · **Level:** Advanced
**Tagline:** A supervisor-led team — Research, Analysis, Writer, and Reviewer — that takes a topic from raw research to a fact-checked, revised final brief.
...
```bash
cd project_4_multi_agent_system
python -m venv .venv
...
*Project: **ContentForge-Multi-Agent-Turn-Any-Topic-Into-A-Published-Brief** — Step 1 of 5: One Specialist's Drafting Logic, Working Alone, No Agent Behavior*
...
3. Test it directly against 2-3 made-up "research notes" inputs, read the drafts, and confirm the chain itself works well.
...
**Stuck on this step?** [Hint 1](hints_and_solutions/step1_writer_chain_hints.md#hint-1) · [Hint 2](hints_and_solutions/step1_writer_chain_hints.md#hint-2) · [Hint 3](hints_and_solutions/step1_writer_chain_hints.md#hint-3) · [Hint 4](hints_and_solutions/step1_writer_chain_hints.md#hint-4) · [Show me the solution](hints_and_solutions/step1_writer_chain_solution.md)
...
*Project: **ContentForge-Multi-Agent-Turn-Any-Topic-Into-A-Published-Brief** — Step 2 of 5: That Specialist, Now a Real Agent That Can Improve Its Own Work*
...
2. Build a small, standalone Reviewer as a second simple chain (no tools either) that scores a draft and gives back feedback text.
...
**Stuck on this step?** [Hint 1](hints_and_solutions/step2_writer_reviewer_loop_hints.md#hint-1) · [Hint 2](hints_and_solutions/step2_writer_reviewer_loop_hints.md#hint-2) · [Hint 3](hints_and_solutions/step2_writer_reviewer_loop_hints.md#hint-3) · [Hint 4](hints_and_solutions/step2_writer_reviewer_loop_hints.md#hint-4) · [Show me the solution](hints_and_solutions/step2_writer_reviewer_loop_solution.md)
...
*Project: **ContentForge-Multi-Agent-Turn-Any-Topic-Into-A-Published-Brief** — Step 3 of 5: A Research Agent That Looks Things Up Before Anyone Else Works*
...
1. Build the Research agent the same way you built Writer in Steps 1-2: a simple chain first if possible, turned into an agent with a lookup tool, since Research genuinely needs one (reuse Doc06's patterns).
...
**Stuck on this step?** [Hint 1](hints_and_solutions/step3_research_agent_hints.md#hint-1) · [Hint 2](hints_and_solutions/step3_research_agent_hints.md#hint-2) · [Hint 3](hints_and_solutions/step3_research_agent_hints.md#hint-3) · [Hint 4](hints_and_solutions/step3_research_agent_hints.md#hint-4) · [Show me the solution](hints_and_solutions/step3_research_agent_solution.md)
...
*Project: **ContentForge-Multi-Agent-Turn-Any-Topic-Into-A-Published-Brief** — Step 4 of 5: An Analysis Agent That Turns Raw Research Into Organized Findings*
...
1. Build the Analysis agent: takes Step 3's `ResearchNotes`, produces organized findings the Writer can draft from.
...
**Stuck on this step?** [Hint 1](hints_and_solutions/step4_analysis_agent_hints.md#hint-1) · [Hint 2](hints_and_solutions/step4_analysis_agent_hints.md#hint-2) · [Hint 3](hints_and_solutions/step4_analysis_agent_hints.md#hint-3) · [Hint 4](hints_and_solutions/step4_analysis_agent_hints.md#hint-4) · [Show me the solution](hints_and_solutions/step4_analysis_agent_solution.md)
...
*Project: **ContentForge-Multi-Agent-Turn-Any-Topic-Into-A-Published-Brief** — Step 5 of 5: The Full Team: a Supervisor Routing 4 Specialists via Command*
...
1. Design the shared state shape — clear about what's shared (the growing brief) vs. private to each agent (each specialist's own working notes), following Doc11's warning about notes leaking between agents.
2. Build the Supervisor node: routes to Research → Analysis → Writer → Reviewer in order, using `Command`, keeping track of what's already been done so no agent redundantly repeats another's work.
...
**Stuck on this step?** [Hint 1](hints_and_solutions/step5_supervisor_command_hints.md#hint-1) · [Hint 2](hints_and_solutions/step5_supervisor_command_hints.md#hint-2) · [Hint 3](hints_and_solutions/step5_supervisor_command_hints.md#hint-3) · [Hint 4](hints_and_solutions/step5_supervisor_command_hints.md#hint-4) · [Show me the solution](hints_and_solutions/step5_supervisor_command_solution.md)
...
**Final Deliverable:** **ContentForge-Multi-Agent-Turn-Any-Topic-Into-A-Published-Brief** — a Supervisor that routes Research, Analysis, Writer, and Reviewer on the fly via `Command`, with a carefully-designed shared state and a limited revision loop, turning a raw topic into a fact-checked final brief.

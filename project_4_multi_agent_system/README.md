...
**Why this step matters:** everything downstream — Analysis, the draft, the whole brief — is only as trustworthy as the research it started from; proving Research works alone means a bad brief can never be blamed on a Research bug hiding three steps later.

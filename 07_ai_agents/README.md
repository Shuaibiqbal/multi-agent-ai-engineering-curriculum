...
Docs 05-07 are everything Project 2 needs. Go to [project_2_tool_using_agent/](../project_2_tool_using_agent/) and start with its **Setup** section — the step-by-step build guide there (not the Build Task summary above) is what you actually follow.

...
The README says it plainly: "literally repeat Project 5's Steps 1-4, on this codebase instead of ContentForge's. No new ideas here." Go open Project 5's own hints and solutions (`project_5_production_capstone/hints_and_solutions/`) and use them as your working reference for this entire step — that's not cheating, it's the point.

...
## Features
- Hand-built think→act→observe agent loop (no `AgentExecutor`) that calls 3+ real, Pydantic-validated tools to answer a question
...
- Hand-built agent loop (no `AgentExecutor`)

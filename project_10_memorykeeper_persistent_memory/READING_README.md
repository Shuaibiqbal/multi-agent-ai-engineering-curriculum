...
> Not part of the numbered Doc01-19 project arc — a bonus/portfolio project built on [09_langgraph](../09_langgraph/)'s "Long-term memory" topic, using [01_python_foundations](../01_python_foundations/)'s config/logging pattern and [04_openai_api](../04_openai_api/)'s chat patterns. Read Doc09's Core Concepts first if you haven't already — this file has the full build spec, not a pointer elsewhere.

# Project 7 (Bonus) — MCPForge-Local-Notes-And-Tasks-MCP-Server
...
> Not part of the numbered Doc01-19 sequence in the way Projects 1-6 are — this bonus project teaches one specific technology, MCP server-building, using skills you already have from [01_python_foundations](../01_python_foundations/) (config/logging) and [06_tools_function_calling](../06_tools_function_calling/) (precise tool descriptions, and Doc06's own MCP sections). Full detail lives here, and only here.
...
*Project: **MCPForge-Local-Notes-And-Tasks-MCP-Server** — Step 1 of 4: A Minimal Server With One Tool*
...
*Project: **MCPForge-Local-Notes-And-Tasks-MCP-Server** — Step 2 of 4: A Real SQLite-Backed Store, and the Search Tool*
...
*Project: **MCPForge-Local-Notes-And-Tasks-MCP-Server** — Step 3 of 4: Add the Resource and the Prompt*
...
*Project: **MCPForge-Local-Notes-And-Tasks-MCP-Server** — Step 4 of 4: A Real Client That Connects and Uses All Three*
...
**Final Deliverable:** **MCPForge-Local-Notes-And-Tasks-MCP-Server** — a real MCP server exposing 2 Tools (`add_note`, `search_notes`), 1 Resource (`notes://all`), and 1 Prompt (`summarize_notes`), backed by a real SQLite database, plus a standalone client script that proves the full connect → discover → use loop works end to end.

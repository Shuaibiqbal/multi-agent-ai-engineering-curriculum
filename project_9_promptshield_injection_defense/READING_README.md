...
> Not part of the numbered Doc01-19 project arc — a bonus/portfolio project built on [06_tools_function_calling](../06_tools_function_calling/README.md#prompt-injection-when-the-attack-comes-from-content-not-the-user)'s "Prompt injection: when the attack comes from content, not the user" and [08_rag](../08_rag/README.md#core-concepts-read-this-first-everything-you-need-is-here)'s "RAG-specific prompt injection" topics. Read Doc06's and Doc08's Core Concepts first if you haven't already — this file has the full build spec, not a pointer elsewhere.
